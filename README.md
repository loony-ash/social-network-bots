...
На рисунках ниже показаны цены на лайки и комментарии одной из типичных бирж заданий в соц. сетях на момент 4 августа 2025 года.  

<p align="center">
  <img src="./img/like_cost_bosslike.png" alt="Цена лайки">
</p>  
<div style="text-align: center; margin-top: -20px; margin-bottom: 30px;">
    Рисунок 9: Пример цены на лайк поста сообщества ВКонтакте
</div>  
<p align="center">
  <img src="./img/comm_cost_bosslike.png" alt="Цена комментарии">
</p>  
<div style="text-align: center; margin-top: -20px; margin-bottom: 30px;">
    Рисунок 10: Пример цены на комментарий поста сообщества ВКонтакте
</div>  
